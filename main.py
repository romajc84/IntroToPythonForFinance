...
while stock != "quit":
  ...
  plt.axvline(x=stdev+mean, ymin=0, ymax=1,
              color='gray', alpha=1, linestyle='--')
  plt.axvline(x=2*stdev+mean, ymin=0, ymax=1,
              color='gray', alpha=.75, linestyle='--')
  plt.axvline(x=3*stdev+mean, ymin=0, ymax=1,
  ...
  ax1.xaxis.set_major_locator(
      mticker.MaxNLocator(14))  # add more x axis labels
